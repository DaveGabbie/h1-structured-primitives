"""
Test Simplified PICO-Contrastive RAG
"""
...
def load_mimic_data(n_patients=2000):
    """Load MIMIC-IV data."""
...
def create_corpus_embeddings(n_docs=200, embedding_dim=768):
...
def main():
    print("="*60)
    print("SIMPLIFIED PICO-CONTRASTIVE RAG ON MIMIC-IV")
    print("="*60)
    
    # Load MIMIC-IV data
    df = load_mimic_data(n_patients=2000)
    ...
    corpus_embeddings = create_corpus_embeddings(n_docs=200, embedding_dim=768)
    ...
    # Train and evaluate Simplified PICO-Contrastive RAG
    print("\n" + "="*50)
    print("Simplified PICO-Contrastive RAG")
    print("="*50)
    ...
    output_path = os.path.join(os.path.dirname(__file__), 'simple_pico_contrastive_rag_results.json')
